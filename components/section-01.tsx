        ...
        <div className="py-12 md:py-28 md:pb-20">
          ...
          <div className="max-w-sm mx-auto grid gap-12 md:grid-cols-3 md:-mx-9 md:gap-0 items-start md:max-w-none">
                ...
                <svg width="56" height="56" xmlns="http://www.w3.org/2000/svg">
                  <defs>
                    <linearGradient x1="50%" y1="100%" x2="50%" y2="0%" id="a">
                      <stop stopColor="#C46941" offset="0%" />
                      <stop stopColor="#D26237" offset="100%" />
                    </linearGradient>
                  </defs>
            ...
            >
              ...
              <p className="text-slate-500">
                The right random page can reignite a passion, stoke your fascination, or remind you of something you'd long since forgotten. 
              </p>
            </div>
            ...
            >
              <div className="mb-3">
                <svg width="56" height="56" xmlns="http://www.w3.org/2000/svg">
                  <defs>
                    <linearGradient x1="50%" y1="100%" x2="50%" y2="0%" id="a">
                      <stop stopColor="#C46941" offset="0%" />
                      <stop stopColor="#C46941" offset="100%" />
                    </linearGradient>
                  </defs>
                  <g fillRule="nonzero" fill="none">
                    <path
              ...
              <h4 className="text-xl font-bold mb-1">Learn Something Old</h4>
              <p className="text-slate-500">
                There's a random topic you were fascinated with years ago just a
                click away. Find out what's new or see what's changed.
              </p>
            </div>
          </div>
        </div>
