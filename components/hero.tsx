...
import HeroImage from '@/public/images/get-random-bm-right-lg.png'
...
export default function Hero() {
  return (
    <section className="relative">
      {/* Bg */}
      <div
        className="absolute inset-0 rounded-bl-[100px] mb-28 md:mb-0 bg-gradient-to-tr from-orange-400 to-orange-400 pointer-events-none -z-10"
        aria-hidden="true"
      />
          ...
          <div className="relative max-w-xl mx-auto md:max-w-none text-center md:text-left">
            ...
            <div className="md:w-[600px]">
              ...
              <h1
                ...
                data-aos-delay="100"
              >
                Open to a random bookmark with each{" "}
              ...
              >
                ...
                <div>
                  <Link
                    className="btn-sm w-full inline-flex items-center text-white bg-orange-600 hover:bg-slate-900 shadow-sm relative before:absolute before:inset-0 before:bg-orange-600 before:bg-opacity-0 before:-z-10 before:rounded-full"
