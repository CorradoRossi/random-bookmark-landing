        ...
        <article>
          <div className="flex items-center mb-4">
            ...
            <span className="text-lg font-bold text-slate-800 ml-2.5">
              {post.metadata.topicName}
            </span>
          </div>
          <h1 className="h3 text-slate-800 mb-4">{post.metadata.title}</h1>
          <div className="prose text-slate-500 font-[350] max-w-none prose-p:leading-normal prose-headings:text-slate-800 prose-a:text-orange-custom prose-a:font-[550] prose-a:no-underline hover:prose-a:underline">
